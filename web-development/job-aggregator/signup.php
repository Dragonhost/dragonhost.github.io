...
if(isset($_REQUEST['status'])){
  ...
  if($status == 'noaccount'){
    echo "<h5 class='container w-50 mt-5 text-center bg-white rounded p-2 text-danger'>No Account! Please Signup</h5>";
  }
...
<div class="container mt-5 p-5 rounded bg-white">
    <h2 class="text-info mb-3">Signup</h2>
    <form method="post">
