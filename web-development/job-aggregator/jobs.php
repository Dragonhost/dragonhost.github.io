        ...
        <div class="col-md-3">
            <div class="rounded bg-white pt-4 p-3 ">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h3 class="text-success m-0">Filter</h3>
                    <div class="min_max  d-sm-none ">
                            <button class="btn btn-info d-none d-inilne-block" onclick="show_filter()" id="plus"><i class="fas fa-plus"></i></button>
                            <button class="btn btn-danger d-none d-inline-block" onclick="hide_filter()" id="minus"><i class="fas fa-minus"></i></button>
                    </div>
                </div>
                
                <form method="GET" class="d-none d-block" id="filter_options">
                    <h5>Category</h5>
                    ...
                    <div class="buttons">
                        ...
                        <button type="submit" class="btn btn-danger mt-3" name="clear"><a href="jobs.php" class="text-white">clear</a></button>
    ...
    data-aos-easing="ease-in-out">
                <div class="row">
                    <?php if(mysqli_num_rows($result_data) > 0){ 
                        foreach( $result_data as $r_jobs){
                    ?>
                        <div class="col-md-6">
                            <div class="bg-white p-4 mb-3 rounded" style="min-height: 300px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <p><?php echo substr(strip_tags($r_jobs['description']), 0, 100);?> ...</p>
                                    </div>
                                </div>
